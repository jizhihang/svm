function [process_matrix_err,process_matrix_sv,process_matrix_time, label_process] = fslssvm(X,Y,k,function_type,kernel_type,global_opt,user_process,window,testX,testY)
